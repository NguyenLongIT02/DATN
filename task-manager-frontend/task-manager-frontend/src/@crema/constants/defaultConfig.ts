...
const defaultConfig = {
  ...
  themeMode: import.meta.env.VITE_THEME_MODE as string,
  footerType: FooterType.FLUID,
  navStyle: import.meta.env.VITE_NAV_STYLE as string,
  layoutType: import.meta.env.VITE_LAYOUT_TYPE as string,
  footer: false,
  rtlLocale: [], // Không có ngôn ngữ RTL nào trong EN và VI
};
