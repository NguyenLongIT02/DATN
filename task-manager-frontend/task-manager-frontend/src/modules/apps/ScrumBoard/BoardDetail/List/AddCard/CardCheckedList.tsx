...
const CardCheckedList: React.FC<CardAttachmentsProps> = ({
  ...
  // Ensure checkedList is a valid array
  ...
  return (
    <StyledScrumBoardCardCheckList>
      ...
      {safeCheckedList.map((checkedItem) => {
        // Validate checkedItem object
        if (!checkedItem || typeof checkedItem.id === "undefined") {
          console.warn("Skipping invalid checked item:", checkedItem);
          return null;
        }
