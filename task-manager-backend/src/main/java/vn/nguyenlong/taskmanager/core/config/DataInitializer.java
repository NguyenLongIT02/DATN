...
public class DataInitializer implements CommandLineRunner {
    ...
    private void cleanupOldTables() {
        ...
        String[] oldTables = {
            ...
            "tbl_task_label", "tbl_task_member", "tbl_task_checklist",
            "tbl_level", "tbl_nguoi_dung_level", "tbl_quyen", "tbl_vai_tro_quyen"
        };
    ...
    private void createProjectBoard(User owner, List<User> allUsers, String projectName, int projectIndex, boolean hasWorkflow) {
        ...
        BoardRoleEntity teamLeadRole = new BoardRoleEntity(savedBoard, "Team Lead", "Trưởng nhóm", false, new ArrayList<>());
